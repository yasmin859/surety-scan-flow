...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Merchant Risk Engine" },
      {
        name: "description",
        content: "Explainable merchant onboarding risk scoring and 3-stage lifecycle management.",
      },
      { property: "og:title", content: "Merchant Risk Engine" },
      {
